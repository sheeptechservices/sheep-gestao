...
export function WeeklyBoardCard({ task, project, isDragging, onDragStart, onDragEnd, onClick, onToggleDone, onDelete }: {
  ...
  return (
    <div
      ...
      style={{
        background: isDragging ? accentColor + '12' : bloqueado ? 'rgba(220,38,38,0.07)' : atencao ? 'rgba(124,58,237,0.07)' : revisar ? 'rgba(217,119,6,0.07)' : hov ? 'rgba(0,0,0,0.015)' : 'var(--white)',
        borderRadius: 10,
