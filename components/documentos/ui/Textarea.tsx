...
export function Textarea({ label, hint, error, id, className, style, onFocus, onBlur, onMouseEnter, onMouseLeave, ...props }: TextareaProps) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
      ...
      <textarea
        id={inputId}
        className={`docs-textarea${className ? ` ${className}` : ''}`}
        rows={4}
        style={{
          borderRadius: 8,
