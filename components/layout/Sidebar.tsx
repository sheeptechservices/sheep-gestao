    ...
    items: [
      {
        href: '/integrations',
        label: 'Integrações',
        icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>,
      },
      {
        href: '/settings',
        label: 'Configurações',
...
export function Sidebar() {
  ...
  return (
    <aside style={{
      ...
      flexShrink: 0,
      ...(effectivePinned ? {
        // In-grid: overflow:hidden clips content during column-width animation
        overflow: 'hidden',
        minWidth: 0,
      } : {
        position: 'fixed',
